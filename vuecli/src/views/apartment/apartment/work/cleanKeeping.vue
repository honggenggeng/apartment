 ...
 <Button icon="ivu-icon ivu-icon-search" @click="search"></Button>
		...
		<div style="padding: 30px 10px;">
			<Form v-if="ok" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="100">
				<Row>
					<Col span="12">
					<FormItem label="酒店" prop="catagory">
				...
				<Row>
	                  <Col span="12">
                                        					<FormItem label="保洁阿姨" prop="weight">
                                        							<Input style="width:100%"  placeholder="Enter something..."></Input>

                                        					</FormItem>
                                        					</Col>
                                     <Col span="12">
                    					<FormItem label="申请人" prop="weight">
	...
	export default {
...

        {
        ...
        },
         {
				...
				tableData1: [{
						buildingName: '锦江之星',
						buildingAddress: '1012',
						createTime: '已打扫',
						businessCircle: '王五',
						city: '打扫卫生',
                        brightSpot:'2018-8-31 10:00:00',
                        codeConduct:'2018-8-31 18:00:00',
                       serviceFacility:'李四'
					}
				],
			}
