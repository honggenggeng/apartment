 ...
 <Button icon="ivu-icon ivu-icon-search" @click="search"></Button>
		...
		<div style="padding: 30px 10px;">
			<Form v-if="ok" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="120">
				<Row>
					<Col span="12">
					<FormItem label="楼栋" prop="catagory">
				...
				<Row>
					<Col span="12">
                				...
                				<Col span="12">
                                					<FormItem label="房客" prop="catagory">
                                						<Input v-model="formValidate.catagory" style="width:100%"  placeholder="Enter something..."></Input>
                                					</FormItem>
                                					</Col>
				</Row>
				<Row>
                					<Col span="12">
                                					<FormItem label="管家" prop="name">
                                							<Input v-model="formValidate.catagory" style="width:100%"  placeholder="Enter something..."></Input>
                                                                                    					</FormItem>
                                					</Col>
                                				<Col span="12">
                				...
                				<Row>
                                                					<Col span="12">
                                                                					<FormItem label="房费金额" prop="name">
                                                                							<InputNumber  v-model="formValidate.name" style="width:100%" :min="1"  placeholder="Enter something..."></InputNumber>
                                                                                                                                                                                                                       					</FormItem>
                                                                					</Col>
                                                                				<Col span="12">
                                                                                					<FormItem label="押金金额" prop="catagory">
                                                                                						<InputNumber  v-model="formValidate.name" style="width:100%" :min="1"  placeholder="Enter something..."></InputNumber>
                                                                                                                    					</FormItem>
                                                                                					</Col>
                                                				</Row>
				<Row>
				  <Col span="12">
	               ...
	               <Col span="12">
                                                                       					<FormItem label="金额" prop="catagory">
                                                                       						<InputNumber  v-model="formValidate.name" style="width:100%" :min="1"  placeholder="Enter something..."></InputNumber>
                                                                                                       					</FormItem>
                                                                       					</Col>
                                     <Col span="12">
...

        {
        ...
        },
         {
				...
				tableData1: [{
						...
						buildingAddress: '张三',
						createTime: '2012',
						businessCircle: '2018-8-31',
						city: '2018-9-31',
                        brightSpot:'李四',
                       // codeConduct:'不接受18岁以下客人在无监护人陪同的情况下入住',
                       serviceFacility:'1548'
					}
				],
			}
		},
