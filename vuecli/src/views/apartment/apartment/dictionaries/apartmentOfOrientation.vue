	...
	<div class="operation" id="bb">
		<div class="wrap">
			...
			<Form v-if="ok" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="100">
				<Row>					
					<Col span="12">
					<FormItem label="朝向代码" prop="apartmentDirectionCode">
						<Input v-model="formValidate.apartmentDirectionCode" placeholder="请输入字典名称"></Input>
					</FormItem>
					</Col>
				</Row>
				<Row>
				<Col span="12">
				<FormItem label="朝向名称" prop="apartmentDirectionName">
					<Input v-model="formValidate.apartmentDirectionName" placeholder="请输入表名称"></Input>
				</FormItem>
				</Col>
		...
		data() {
			return {
				...
				columns4: [{
					...
					{
						title: '状态代码',
						key: 'apartmentDirectionCode'
					},
					{
						title: '状态名称',
						key: 'apartmentDirectionName',
				...
				tableData1: [{
						apartmentDirectionCode: '001',						
						apartmentDirectionName: '朝东',

					},
					{
						apartmentDirectionCode: '002',						
						apartmentDirectionName: '朝南',
					}
