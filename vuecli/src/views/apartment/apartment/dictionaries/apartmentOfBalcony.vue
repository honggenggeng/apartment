		...
		<div class="wrap">
			...
			<Form v-if="ok" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="100">
				...
				<Row>
					...
					<Col span="12">
					<FormItem label="阳台代码" prop="apartmentBalconyCode">
						<Input v-model="formValidate.apartmentBalconyCode" placeholder="请输入字典名称"></Input>
					</FormItem>
					</Col>
				</Row>
				<Row>					
					<Col span="12">
					<FormItem label="阳台名称" prop="apartmentBalconyName">
						<Input v-model="formValidate.apartmentBalconyName" placeholder="请输入字段名称"></Input>
					</FormItem>
					</Col>
				</Row>
				<Col span="12">
		...
		data() {
			return {
				...
				columns4: [{
					...
					{ 
						title: '阳台代码',
						key: 'apartmentBalconyCode'
					},
					{
						title: '阳台名称',
						key: 'apartmentBalconyName',
				...
				tableData1: [
					{ 
						...
						apartmentBalconyCode: '001',
						apartmentBalconyName: '全封闭阳台'
						
					},
					{
						
						apartmentBalconyCode: '002',
						apartmentBalconyName: '非封闭阳台',
					}
				]
			}
		},
