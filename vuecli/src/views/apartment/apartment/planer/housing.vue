...
<Row>
  <Col span="8">
                                                        					<FormItem label="配套服务" prop="weight" >
                                                        						<FormItem v-for="(list,index) in lists" :key="index">
...
<Checkbox style="float: right;"></Checkbox>
                                                        					...
                                                        					<Input v-model="formValidate.weight"></Input>
                                                        					   ...
                                                        					   <p style="text-align: right;"><Button  @click="add">
                                                                                                                                                                                                                                                                                                                                                                                            添加
                                                                                                                                                                                                                                                                                                                                                                                          </Button> <Button class="button" v-on:click="del(index)"> 删除</Button></p>
                                                        					   	</Col>
                                                                                      ...
                                                                                      <Col span="8">
                                                                                                                                            					...
                                                                                                                                            					<FormItem v-for="(list,index) in listsc" :key="index">
                                                                                                                                            					 <img  src="../../../../images/sdd.jpg" key="max-logo"/>


                                                                                                                                            					<Checkbox style="float: right;"></Checkbox> <Upload
                                                                                                                                                                        multiple
                                                                                                                                                                        action="//jsonplaceholder.typicode.com/posts/">
                                                                                                                                                                        <Button icon="ios-cloud-upload-outline">Upload files</Button>
                                                                                                                                                                    </Upload>

                                                                                                                                            					<Input v-model="formValidate.weight" placeholder="衣柜" style="    width: 40%;
                                                                                                                                                                                                                                 float: left;
                                                                                                                                                                                                                                 margin-right: 10px;"></Input>
                                                                                                                                            					<InputNumber v-model="formValidate.weight"  :min="1" placeholder="" style="    width: 40%;
                                                                                                                                                                                                                                 float: left;
                                                                                                                                                                                                                                 margin-right: 10px;"></InputNumber><span>件</span>
                                                                                                                                            					   </FormItem>
                                                                                                                                            					    </FormItem>
                                                                                                                                            					    	<p style="text-align: right;"><Button  @click="addc">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     添加
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   </Button> <Button class="button" v-on:click="delc(index)"> 删除</Button></p>
                                                                                                                                            					   	</Col>
