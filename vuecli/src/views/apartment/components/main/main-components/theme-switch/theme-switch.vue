...
export default {
    ...
    methods: {
        setTheme (themeFile) {
            ...
            if (config.env.indexOf('dev') > -1) {
                stylePath = './src/views/apartment/components/main/main-components/theme-switch/theme/';
            } else {
                stylePath = 'dist/';
            }
            if (mainTheme !== 'b') {
    ...
    created () {
        let path = '';
        if (config.env.indexOf('dev') > -1) {
            path = './src/views/apartment/components/main/main-components/theme-switch/theme/';
        } else {
            path = 'dist/';
        }
