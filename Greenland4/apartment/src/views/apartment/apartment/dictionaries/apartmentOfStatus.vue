	...
	<div class="operation" id="bb">
		<div class="wrap">
			...
			<Form v-if="ok" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="right" :label-width="100">
				<Row>					
					<Col span="12">
					<FormItem label="状态代码" prop="apartmentStatusCode">
						<Input v-model="formValidate.apartmentStatusCode" placeholder="请输入字典名称"></Input>
					</FormItem>
					</Col>
				</Row>
				<Row>
				<Col span="12">
				<FormItem label="状态名称" prop="apartmentStatusName">
					<Input v-model="formValidate.apartmentStatusName" placeholder="请输入表名称"></Input>
				</FormItem>
				</Col>
	...
	export default {
		data() {
			return {
				...
				tableData1: [{
						apartmentStatusCode: '001',						
						apartmentStatusName: '订单中',

					},
					{
						apartmentStatusCode: '002',						
						apartmentStatusName: '订单中',
					}
